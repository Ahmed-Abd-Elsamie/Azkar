...
import com.example.root.azkar.MainActivity;
...
public class NewMessageNotification {
     ...
     * @see #cancel(Context)
     */
    public static void notify(final Context context, final String exampleString, final int number , final String plainText) {
        final Resources res = context.getResources();

        // This image is used as the notification's large icon (thumbnail).
        // TODO: Remove this if your notification has no relevant thumbnail.
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.mosque);

        // Read Intent Action

        Intent i = new Intent(context , TimeClockActivity.class);

        TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);
        taskStackBuilder.addParentStack(TimeClockActivity.class);
        ...
        final String text = res.getString(
                R.string.new_message_notification_placeholder_text_template, plainText);
                ...
                .addAction(
                        ...
                        PendingIntent.getActivity(
                                ...
                                Intent.createChooser(new Intent(Intent.ACTION_SEND)
                                        .setType("text/plain")
                                        .putExtra(Intent.EXTRA_TEXT, plainText), exampleString),
                                PendingIntent.FLAG_UPDATE_CURRENT))
                .addAction(
